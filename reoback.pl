...
# GLOBAL VARIABLES
###########################################################################
my %config;             # Hash containing REOBack configuration data.C
...
my $fileSize;           # ADD by CJ local file size
my $totalSize = 0;      # ADD by CJ total size
